...
%  that states that given a sufficiently large sample size 
%  from a population with a finite level of variance, 
%  the mean of all samples from the same population will be approximately 
%  equal to the mean of the population.
% So, we can see the histfit result from the subplots and we can say the 
% plot is fit with the CLT.
